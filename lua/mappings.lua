...
key_mapper('n', 'gE', '<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>')
key_mapper('n', 'ge', '<cmd>lua vim.lsp.diagnostic.goto_next()<CR>')
key_mapper('n', 'K', ':Lspsaga hover_doc<CR>')
key_mapper('n', '<leader>k', ':Lspsaga show_line_diagnostics<CR>')
